...
- `locale.tsx` — جدول النصوص: 1,396 مفتاح، كل واحد `{ ar, en }`، بيتقري بـ `t('key')` ومفاتيحه
...
قبل ما يتنفذوا — وكلها معلَّمة بـ`DevNote` لأن التلاتة إجراءات إدارية في WHMCS. البوابات
