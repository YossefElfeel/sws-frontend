...
export const STRINGS = {
  ...
  // Domain step — the TLD picker and the from-cart choice (spec 7.2.1).
  'domainstep.tld': { ar: 'الامتداد', en: 'Extension' },
  'domainstep.fromCartPick': { ar: 'اختار الدومين من سلتك', en: 'Pick the domain from your cart' },
  'domainstep.pickFromCart': { ar: 'اختار دومين…', en: 'Choose a domain…' },

  // Domain configuration step — O-03.
  'domainsconf.lede': {
    ar: 'التلاتة دول ببلاش مع أي دومين بتسجّله أو بتنقله. فعّل اللي محتاجه دلوقتي، وتقدر تغيّر رأيك بعدين من لوحة الحساب.',
    en: 'All three are free with any domain you register or transfer. Turn on what you need now; you can change your mind later from the account.',
  },
  'domainsconf.dnsNote': { ar: 'عدّل سجلات A وMX وTXT من عندنا من غير ما تحتاج استضافة.', en: 'Edit A, MX and TXT records here, with or without hosting.' },
  'domainsconf.idNote': { ar: 'بيخفي اسمك وعنوانك من سجل WHOIS العام.', en: 'Hides your name and address from the public WHOIS record.' },
  'domainsconf.forwardingNote': { ar: 'حوّل أي عنوان على الدومين لبريدك الحالي.', en: 'Forward any address on the domain to the mailbox you already use.' },
  'domainsconf.perYear': { ar: 'سنة', en: 'year' },

  // VPS server settings — O-01.
  'vps.settings': { ar: 'إعدادات الخادم', en: 'Server settings' },
  'vps.settingsNote': {
    ar: 'دي البيانات اللي بنجهّز بيها السيرفر. كلمة مرور الروت مش بتتحفظ عندنا بعد التجهيز.',
    en: 'This is what the server is provisioned with. The root password is not kept after provisioning.',
  },
  'vps.hostname': { ar: 'اسم الخادم', en: 'Hostname' },
  'vps.hostnameBad': { ar: 'اكتبه كاسم كامل زي srv1.example.com', en: 'Write it as a full name, like srv1.example.com' },
  'vps.rootPassword': { ar: 'كلمة مرور الروت', en: 'Root password' },
  'vps.pwRule': { ar: '10 حروف على الأقل.', en: 'At least 10 characters.' },
  'vps.show': { ar: 'اظهر', en: 'Show' },
  'vps.hide': { ar: 'اخفي', en: 'Hide' },
  'vps.ns1': { ar: 'خادم الأسماء الأول (NS1)', en: 'Nameserver 1 (NS1)' },
  'vps.ns2': { ar: 'خادم الأسماء الثاني (NS2)', en: 'Nameserver 2 (NS2)' },
  'vps.nsBad': { ar: 'اسم كامل زي ns1.example.com', en: 'A full name, like ns1.example.com' },

  // Per-gateway notes and instructions — spec 11, O-07.
  'pay.note.stripeCard': { ar: 'فيزا وماستركارد — بنكك ممكن يطلب تأكيد.', en: 'Visa and Mastercard — your bank may ask you to confirm.' },
  'pay.note.stripeEu': { ar: 'TWINT أو Klarna على صفحة Stripe.', en: 'TWINT or Klarna, on Stripe’s page.' },
  'pay.note.wallet': { ar: 'كروت ومحافظ مصرية بالجنيه، على صفحة مزوّد الدفع.', en: 'Egyptian cards and mobile wallets in EGP, on the provider’s page.' },
  'pay.note.instapay': { ar: 'تحويل فوري من تطبيق بنكك — وبعدين ابعتلنا الإيصال.', en: 'An instant transfer from your bank app — then send us the receipt.' },
  'pay.note.bank': { ar: 'تحويل بنكي (IBAN) — بيوصل في يوم لتلات أيام عمل.', en: 'Bank transfer (IBAN) — arrives in one to three working days.' },
  'pay.how.stripeCard': {
    ar: 'هتكتب بيانات الكارت في الشاشة الجاية جوه نموذج Stripe الآمن. بنكك ممكن يطلب منك تأكيد، وبعدها بترجع هنا.',
    en: 'You enter the card on the next screen, inside Stripe’s secure form. Your bank may ask you to confirm; then you come back here.',
  },
  'pay.how.stripeEu': {
    ar: 'هنحوّلك لصفحة Stripe عشان تدفع بـ TWINT أو Klarna، وبعد ما تخلص بترجع هنا لوحدك. ماتقفلش التاب.',
    en: 'We take you to Stripe’s page to pay with TWINT or Klarna, and bring you back here when it is done. Don’t close the tab.',
  },
  'pay.how.wallet': {
    ar: 'هنحوّلك لصفحة مزوّد الدفع الآمنة عشان تدفع بكارت مصري أو من محفظتك بالجنيه، وبعد ما تخلص بترجع هنا لوحدك.',
    en: 'We take you to the provider’s secure page to pay with an Egyptian card or a mobile wallet in EGP, and bring you back here when it is done.',
  },
  'pay.how.instapay': {
    ar: 'حوّل المبلغ بالظبط على عنوان إنستاباي اللي تحت واكتب الرقم المرجعي في خانة الملاحظات. أول ما الإيصال يوصلنا بنفعّل في نفس يوم العمل.',
    en: 'Send the exact amount to the InstaPay address below and put the reference in the note field. We activate the same working day the receipt reaches us.',
  },
  'pay.how.bank': {
    ar: 'حوّل المبلغ على الحساب اللي تحت واكتب الرقم المرجعي في وصف التحويل. التحويل بياخد من يوم لتلات أيام عمل، والسعر محجوز لك لحد ما يوصل.',
    en: 'Transfer the amount to the account below and quote the reference in the transfer description. It takes one to three working days, and the price is held for you until it arrives.',
  },
  'pay.after.manual': {
    ar: 'بعد ما تحوّل، ارفع الإيصال هنا أو افتح تذكرة مع المبيعات وارفقه عشان نفعّل الطلب.',
    en: 'After paying, upload the receipt here or open a ticket with Sales and attach it so we can activate the order.',
  },
  'pay.refLater': { ar: 'الرقم المرجعي بيظهر في الشاشة الجاية بعد ما تأكد الطلب.', en: 'The reference appears on the next screen once you place the order.' },
  'pay.redirectBack': { ar: 'لو الصفحة ماردّتكش لوحدها، ارجع هنا وافتح الفاتورة — الدفع بيتسجّل عليها.', en: 'If the page does not bring you back, return here and open the invoice — the payment is recorded against it.' },
  'pay.savedCard': { ar: 'هيتخصم من كارتك المحفوظ', en: 'Charged to your saved card' },
  'pay.credit': { ar: 'رصيد الحساب', en: 'Account credit' },
  'pay.reference': { ar: 'الرقم المرجعي', en: 'Reference' },

  // The redirect handoff — the provider’s page is not ours to draw.
  'redir.title': { ar: 'الدفع عند مزوّد الدفع', en: 'Paying with the provider' },
  'redir.goTitle': { ar: 'بنحوّلك لصفحة', en: 'Taking you to' },
  'redir.goBody': {
    ar: 'الدفع بيتم على صفحة مزوّد الدفع نفسه، مش عندنا. خلّص هناك وهترجع هنا لوحدك.',
    en: 'The payment happens on the provider’s own page, not ours. Finish there and you come back here on your own.',
  },
  'redir.go': { ar: 'كمّل عند مزوّد الدفع', en: 'Continue with the provider' },
  'redir.backTitle': { ar: 'رجعت — والدفع اتسجّل', en: 'You are back — the payment went through' },
  'redir.backBody': { ar: 'مزوّد الدفع أكّد العملية. الفاتورة اتقفلت وهتلاقي الإيصال في بريدك.', en: 'The provider confirmed the payment. The invoice is settled and the receipt is on its way to your inbox.' },
  'redir.slotTag': { ar: 'صفحة مزوّد الدفع', en: 'The provider’s page' },
  'redir.slotLabel': { ar: 'مكان صفحة مزوّد الدفع', en: 'Where the provider’s page appears' },
  'redir.slotNote': { ar: 'صفحة بيستضيفها مزوّد الدفع. مش بنرسمها ولا بنتحكم فيها.', en: 'A page the provider hosts. We neither draw it nor control it.' },

  // Currency lock — S-04 after the first payment.
  'cur.lockedTitle': { ar: 'العملة مقفولة على الدولار', en: 'Billing is locked to USD' },
  'cur.lockedBody': {
    ar: 'حسابك بيتحاسب بالدولار من أول دفعة دفعتها، ومش هينفع تتغيّر من هنا. لو عايز تحوّل لعملة تانية افتح تذكرة مع المبيعات وهنظبطها.',
    en: 'You have been billed in USD since your first payment, and it cannot be changed here. To switch to another currency, open a ticket with Sales and we will arrange it.',
  },
  'cur.lockedAsk': { ar: 'افتح تذكرة', en: 'Open a ticket' },
  'cur.lockedClose': { ar: 'تمام', en: 'Got it' },
  'cur.lockedLabel': { ar: 'عملة الفوترة، مقفولة', en: 'Billing currency, locked' },

  // The invoice document — C-15 and C-17.
  'inv.invoicedTo': { ar: 'الفاتورة باسم', en: 'Invoiced to' },
  'inv.issuedBy': { ar: 'صادرة من', en: 'Issued by' },
  'inv.paidOn': { ar: 'اتدفعت في', en: 'Paid on' },
  'inv.period': { ar: 'الفترة', en: 'Period' },
  'inv.tax': { ar: 'الضريبة', en: 'Tax' },
  'inv.taxNote': { ar: 'البنود المعلّمة بنجمة عليها ضريبة', en: 'Items marked with an asterisk are taxed at' },
  'inv.creditApplied': { ar: 'رصيد مستخدم', en: 'Credit applied' },
  'inv.balanceDue': { ar: 'المتبقي للدفع', en: 'Balance due' },
  'inv.paidInFull': { ar: 'مدفوعة بالكامل', en: 'Paid in full' },
  'inv.ledger': { ar: 'سجل الدفع', en: 'Ledger' },
  'inv.noPayments': { ar: 'مفيش دفعات لسه', en: 'No payments yet' },
  'inv.noPaymentsNote': { ar: 'أول ما تدفع هتلاقي العملية هنا بتاريخها ومرجعها.', en: 'Once you pay, the transaction appears here with its date and reference.' },
  'inv.useCredit': { ar: 'استخدم رصيد الحساب', en: 'Use account credit' },
  'inv.useCreditNote': { ar: 'عندك', en: 'You have' },
  'inv.line.domainRenewal': { ar: 'تجديد دومين', en: 'Domain renewal' },
  ...
  'svc.kind.cpanel': { ar: 'استضافة cPanel', en: 'cPanel hosting' },
  'svc.kind.email': { ar: 'استضافة بريد', en: 'Email hosting' },
  'svc.kind.vps': { ar: 'خادم VPS', en: 'VPS server' },
  'svc.autoRenew': { ar: 'تجديد تلقائي', en: 'Auto-renew' },
  'svc.autoRenewOn': { ar: 'بتتجدد لوحدها وبيتخصم من طريقة الدفع بتاعتك في', en: 'Renews on its own and charges your payment method on' },
  'svc.autoRenewOff': { ar: 'مش هتتجدد لوحدها — هنبعتلك فاتورة تدفعها بنفسك قبل', en: 'Will not renew on its own — we send an invoice for you to pay before' },
  'svc.autoRenewOnMsg': { ar: 'التجديد التلقائي اتفعّل', en: 'Auto-renew is on' },
  'svc.autoRenewOffMsg': { ar: 'التجديد التلقائي اتوقف', en: 'Auto-renew is off' },
  'svc.paymentMethod': { ar: 'طريقة الدفع', en: 'Payment method' },
  'svc.usageAt': { ar: 'آخر تحديث', en: 'Last updated' },
  'svc.shortcuts': { ar: 'اختصارات سريعة', en: 'Quick shortcuts' },
  'svc.webmail': { ar: 'ادخل على Webmail', en: 'Log in to Webmail' },
  'svc.password': { ar: 'تغيير كلمة المرور', en: 'Change password' },
  'svc.pwLede': { ar: 'دي كلمة مرور حساب cPanel، مش كلمة مرور دخولك هنا.', en: 'This is the cPanel account password, not the one you sign in here with.' },
  'svc.pwMismatch': { ar: 'الكلمتين مش زي بعض.', en: 'The two passwords do not match.' },
  'svc.builder': { ar: 'عدّل موقعك بمنشئ المواقع', en: 'Edit with the site builder' },
  'svc.mailNew': { ar: 'إنشاء سريع لحساب بريد', en: 'Quick create an email account' },
  'svc.mailName': { ar: 'الاسم', en: 'Name' },
  'svc.mailPassword': { ar: 'كلمة المرور', en: 'Password' },
  'svc.mailCreate': { ar: 'إنشاء', en: 'Create' },
  'svc.mailCreated': { ar: 'حساب البريد اتعمل', en: 'The mailbox was created' },
  'svc.mailBad': { ar: 'الاسم حروف وأرقام ونقطة وشرطة بس، وكلمة المرور 10 حروف على الأقل.', en: 'The name is letters, digits, dots and dashes only, and the password is at least 10 characters.' },
  'svc.addons': { ar: 'إضافات وملحقات', en: 'Add-ons and extras' },
  ...
  'svc.noDomain': { ar: 'الخدمة دي مش مربوطة بدومين مسجّل عندنا.', en: 'This service is not linked to a domain registered with us.' },
  'svc.manageDomain': { ar: 'إدارة الدومين', en: 'Manage the domain' },

  // cPanel destinations, named on the transition screen.
  'cp.email': { ar: 'حسابات البريد', en: 'Email accounts' },
  'cp.forwarders': { ar: 'التحويلات', en: 'Forwarders' },
  'cp.autoresponders': { ar: 'الردود الآلية', en: 'Autoresponders' },
  'cp.files': { ar: 'مدير الملفات', en: 'File Manager' },
  'cp.backups': { ar: 'النسخ الاحتياطي', en: 'Backups' },
  'cp.domains': { ar: 'الدومينات', en: 'Domains' },
  'cp.cron': { ar: 'المهام المجدولة', en: 'Cron jobs' },
  'cp.mysql': { ar: 'قواعد MySQL', en: 'MySQL databases' },
  'cp.phpmyadmin': { ar: 'phpMyAdmin', en: 'phpMyAdmin' },
  ...
  'dom.off': { ar: 'متوقف', en: 'Off' },
  'dom.tld': { ar: 'الامتداد', en: 'Extension' },
  'dom.autoRenew': { ar: 'تجديد تلقائي', en: 'Auto-renew' },
  'dom.autoRenewNote': { ar: 'هنجدّد الدومين لوحدنا قبل ما يخلص بأسبوعين ونبعتلك الفاتورة.', en: 'We renew the domain on our own two weeks before it expires and send you the invoice.' },
  ...
  'dom.dnsNone': { ar: 'مفيش سجلات DNS هنا', en: 'No DNS records here' },
  ...
  'dom.contact.admin': { ar: 'المسؤول الإداري', en: 'Administrative' },
  'dom.contact.tech': { ar: 'المسؤول الفني', en: 'Technical' },
  'dom.contact.billing': { ar: 'مسؤول الفوترة', en: 'Billing' },
  'dom.useAccount': { ar: 'استخدم بيانات الحساب', en: 'Use the account details' },
  'dom.useAccountNote': { ar: 'نفس الاسم والعنوان اللي في حسابك.', en: 'The same name and address as your account.' },
  'dom.custom': { ar: 'بيانات مختلفة', en: 'Different details' },
  'dom.customNote': { ar: 'اكتب بيانات الشخص أو الشركة دي تحت.', en: 'Enter that person’s or company’s details below.' },
  'dom.firstName': { ar: 'الاسم الأول', en: 'First name' },
  'dom.lastName': { ar: 'اسم العائلة', en: 'Last name' },
  'dom.company': { ar: 'اسم الشركة', en: 'Company' },
  'dom.address1': { ar: 'العنوان 1', en: 'Address 1' },
  'dom.address2': { ar: 'العنوان 2', en: 'Address 2' },
  'dom.state': { ar: 'المحافظة', en: 'State or region' },
  'dom.contactsSaved': { ar: 'بيانات الدومين اتحفظت', en: 'Domain contacts saved' },
  'dom.privateNs': { ar: 'خوادم الأسماء الخاصة', en: 'Private nameservers' },
  'dom.privateNsLede': { ar: 'سجّل خوادم أسماء على الدومين نفسه، زي ns1.example.com، وربطها بعناوين IP بتاعتك.', en: 'Register nameservers on the domain itself, like ns1.example.com, and point them at your IP addresses.' },
  'dom.privateNsNone': { ar: 'مفيش خوادم أسماء خاصة على الدومين ده لسه.', en: 'No private nameservers on this domain yet.' },
  'dom.nsHost': { ar: 'اسم الخادم', en: 'Nameserver' },
  'dom.nsIp': { ar: 'عنوان IP', en: 'IP address' },
  'dom.nsIpBad': { ar: 'اكتب عنوان IPv4 صحيح زي 185.42.118.203', en: 'Enter a valid IPv4 address, like 185.42.118.203' },
  'dom.nsRegister': { ar: 'تسجيل خادم أسماء', en: 'Register a nameserver' },
  'dom.nsModify': { ar: 'تعديل عنوان IP', en: 'Change a nameserver’s IP' },
  'dom.nsCurrentIp': { ar: 'الـ IP الحالي', en: 'Current IP' },
  'dom.nsNewIp': { ar: 'الـ IP الجديد', en: 'New IP' },
  'dom.nsDelete': { ar: 'حذف خادم أسماء', en: 'Delete a nameserver' },
  ...
  'dom.forwardingLede': { ar: 'أي رسالة توصل لعنوان على الدومين ده بتتحوّل للبريد اللي تحدده.', en: 'Mail sent to an address on this domain is forwarded to the mailbox you choose.' },
  'dom.alias': { ar: 'العنوان على الدومين', en: 'Address on the domain' },
  'dom.forwardTo': { ar: 'يتحوّل إلى', en: 'Forward to' },
  'dom.forwardAdd': { ar: 'أضف تحويل', en: 'Add a forward' },
  'dom.forwardNone': { ar: 'مفيش تحويلات لسه', en: 'No forwards yet' },
  'dom.forwardNoneNote': { ar: 'أضف أول تحويل من النموذج اللي تحت.', en: 'Add the first forward from the form below.' },
  'dom.forwardOff': { ar: 'تحويل البريد متوقف على الدومين ده. فعّله من الخدمات الإضافية عشان التحويلات تشتغل.', en: 'Email forwarding is off for this domain. Turn it on under Add-ons for the forwards to work.' },
  'dom.transferOutLede': { ar: 'عايز تنقل الدومين لشركة تانية؟ اقفل قفل المُسجِّل، خد كود النقل، وادّيه للشركة اللي ناقل ليها.', en: 'Moving the domain to another registrar? Turn the lock off, take the transfer code, and give it to the registrar you are moving to.' },
  'dom.eppRequest': { ar: 'اطلب كود النقل', en: 'Get the transfer code' },
  ...
  'status.filter.resolved': { ar: 'اللي اتحلّت', en: 'Resolved' },
